...
public class ShopCharacterUpgrade : MonoBehaviour
{
    ...
    {
        currentRangeDamage.text = "伤害: " + (characterID.weaponEffect.normalDamageMin + characterID.UpgradeRangeDamage) + "~" + (characterID.weaponEffect.normalDamageMax + characterID.UpgradeRangeDamage);
        currentCritical.text = "暴击率: " + characterID.UpgradeCriticalDamage + "%";
