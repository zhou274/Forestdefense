...
public class ShopItemReward : MonoBehaviour {
	...
	public TextMeshProUGUI rewardedAmountTxt;
    ...
    private void UpdateAmount()
    {
        ...
        {
            case ItemType.DoubleArrow:
                currentAmountTxt.text = "当前数量: " + GlobalValue.ItemDoubleArrow;
                break;
            case ItemType.Posion:
                currentAmountTxt.text = "当前数量: " + GlobalValue.ItemPoison;
                break;
            case ItemType.Freeze:
                currentAmountTxt.text = "当前数量: " + GlobalValue.ItemFreeze;
                break;
            default:
                break;
        }
