...
public class BoostItemUI : MonoBehaviour
{
    ...
    [Header("Double Arrow")]
    public TextMeshProUGUI DA_remainTxt;
    public Button DA_Button;
    public GameObject DA_Icon;
    public TextMeshProUGUI DA_timerTxt;
